...
/**
 * Repository interface for SupplierLedger entities, providing queries for supplier transaction history.
 */
public interface SupplierLedgerRepository extends JpaRepository<SupplierLedger, Long> {
    /**
     * Finds all ledger entries for a specific supplier, sorted by transaction date descending.
     *
    ...
    /**
     * Checks if a specific supplier already has a ledger entry with the given invoice number.
